...
class subLevelOne(QDialog):
    def __init__(self, value, parent=None):
        super(subLevelOne, self).__init__(parent,\
           flags=Qt.WindowMinimizeButtonHint|Qt.WindowMaximizeButtonHint|Qt.WindowCloseButtonHint)
        loadUi('subLevelOne.ui', self)
        logger.debug("Sub Level One File")
        self.pushButton_goback.clicked.connect(self.goBack)
        logger.debug("Value in Sub Level One is: %s" % value)
        self.ValuePreviousWindow.setText(str(value))
